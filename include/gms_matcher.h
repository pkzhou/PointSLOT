...
public:
	...
	gms_matcher(const vector<KeyPoint> &vkp1, const int &weight1, const int &height1, const vector<KeyPoint> &vkp2, const int &weight2, const int &height2, const vector<DMatch> &vDMatches)
	{
		// Input initialize
		NormalizePoints(vkp1, weight1, height1, mvP1);
		NormalizePoints(vkp2, weight2, height2, mvP2);
...
private:
	...
	void NormalizePoints(const vector<KeyPoint> &kp, const int &width, const int &height, vector<Point2f> &npts) {
