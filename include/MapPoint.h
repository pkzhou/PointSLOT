...
public:
    ...
    MapPoint(const cv::Mat &Pos,  Map* pMap, MapObjectPoint* P);

    // 动态特征点
    MapPoint(const cv::Mat &Pos,  const bool is_dynamic, const bool is_triangulated, const cv::Mat map_to_obj, MapObject* BelongObject, Map* pMap, Frame* pFrame, const int &idxF);
...
public:
    ...
    //TODO Variables used by the dynamic object
    bool mnDynamicFlag = false;
