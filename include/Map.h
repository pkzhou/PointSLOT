...
public:
    ...
    std::vector<MapPoint*> GetAllMapObjectPoints();


    //TODO function define by yuzhen
    void AddMapObject(MapObject *pMO);
    void AddMapObjectPoint(MapPoint* pMP);

    long unsigned int MapObjectPointsInMap();
...
protected:
    ...
    std::set<MapPoint*> mspMapObjectPoints;
